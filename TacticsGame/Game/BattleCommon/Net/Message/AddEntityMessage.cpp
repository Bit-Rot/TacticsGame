...
AddEntityMessage::AddEntityMessage() :
...
ReturnCode AddEntityMessage::init(char* pcBuffer, DWORD dwBufferSize)
{
	/*
...
ReturnCode AddEntityMessage::execute()
{
	//Get entity by id
	Entity* pobjEntity;
...
MessageClassId::MessageClassId AddEntityMessage::getClassId() const
{
	return MessageClassId::AddEntityMessageClassId;
}

ReturnCode AddEntityMessage::getMessageBuffer(char** pcBuffer, DWORD &dwSize) const
{
	/*
...
DWORD AddEntityMessage::getMessageSize() const
{
